...
// Tooltip imports removed; no tooltip used for Connect now
import {
...
function WorkspaceRow({
  ...
  // Compose detection previously disabled Connect; now we allow Connect for Compose too.
